...
# 자세별 조언
posture_feedback = {
    '바른 자세 👍': "🪑 바른 자세를 유지하고 있어요! 아주 좋아요!",
    '구부정한 자세 😓': "💻 허리와 목이 아플 수 있으니, 바른 자세로 앉아보세요.",
    '누워서 😴': "📱 누워서 공부하면 집중력이 떨어지고 건강에 안 좋아요.",
    '책상 앞에 엎드림 😵': "😵 너무 힘든 자세에요. 바른 자세를 권장해요!"
}

# 증상별 조언
symptom_feedback = {
    '손목 저림 ✋': "손목 스트레칭과 휴식이 필요해요.",
    '어깨 결림 🧍‍♂️': "어깨 돌리기와 스트레칭을 자주 해주세요.",
    '종아리 붓기 🦵': "가벼운 다리 스트레칭과 자주 일어나 걷기를 추천해요.",
    '눈 피로 👀': "20분마다 먼 곳을 바라보며 눈 휴식을 취하세요.",
    '두통 🤯': "규칙적인 휴식과 수분 섭취가 중요해요.",
    '허리통증 🧍‍♀️': "올바른 자세와 허리 스트레칭을 해주세요.",
    '목 통증 🦒': "목 스트레칭과 자세 교정을 권장해요."
}

# 식습관별 조언
diet_feedback = {
    '밥 🍚': "균형 잡힌 식사를 하려고 노력 중이네요! 좋아요!",
    '빵 🥐': "탄수화물이 많아요. 채소와 단백질도 챙기세요.",
    '면 🍜': "영양 불균형 주의! 밥과 채소도 섭취하세요.",
    '고기 🍗': "단백질은 좋지만 과도한 섭취는 조절이 필요해요.",
    '채소 🥦': "건강한 선택! 꾸준히 챙기면 좋아요.",
    '간식 위주 🍫': "간식은 줄이고 정식 식사를 잘 챙기도록 해요."
}
